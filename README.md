...
git clone https://github.com/aashikaadh/Web-Based-Bookstore-Management-System

3. **Configure Database Connection**:

   - Update the `config.php` file located in the `root` directory with your database credentials.
